...
<style>
  ...
  <body>
     <nav class="navbar fixed-top bg-body-tertiary shadow-sm">
      <div class="container-fluid p-3">
        <a class="navbar-brand" href="#">
          <img src="../assets/logoNav.png" alt="logo" width="200px">
        </a>
        ...
        <ul style="margin-left: -7rem;" class="dropdown-menu position-absolute mt-2 p-2">
          <li>
            ...
            <img src="../assets/siswa.png" alt="siswa" width="30px">
            </a>
          </li>
          <li>
    ...
    <div class="mt-5 p-4">
      ...
      <div class="alert alert-success" role="alert">Selamat datang member - <span class="text-capitalize fw-bold"><?php echo $_SESSION['member']['nama']; ?> </span> di Dashboard perpustakaan SMAN 2 CIKARANG SELATAN </div>
       ...
       <h3 class="mb-3">Layanan Perpustakaan yang tersedia</h3>
        ...
        <div class="cardImg">
          <a href="buku/daftarBuku.php">
            <img src="../assets/dashboardCardMember/daftarBuku.png" alt="daftar buku" style="max-width: 100%;" width="500px">
          </a>
        </div>
        <div class="cardImg">
          <a href="formPeminjaman/TransaksiPeminjaman.php">
          <img src="../assets/dashboardCardMember/peminjaman.png" alt="daftar buku" style="max-width: 100%;" width="500px">
          </a>
        </div>

        <div class="cardImg">
          <a href="formPeminjaman/TransaksiPengembalian.php">
            <img src="../assets/dashboardCardMember/pengembalian.png" alt="daftar buku" style="max-width: 100%;" width="500px">
          </a>
        </div>
        <div class="cardImg">
          <a href="formPeminjaman/TransaksiDenda.php">
          <img src="../assets/dashboardCardMember/denda.png" alt="daftar buku" style="max-width: 100%;" width="500px">
          </a>
        </div>
       </div>
  ...
  <footer class="shadow-lg bg-subtle p-3">
      ...
      <p class="mt-2">Created by <span class="text-primary"> Rangga Aditiya</span> © 2024</p>
